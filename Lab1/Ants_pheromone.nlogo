...
to recolor-patch  ;; patch procedure
  ...
  [ ifelse food > 0
    ...
    [ if nest-scent > 0 [set pcolor scale-color magenta nest-scent 0.1 5]
      if chemical > 0 [set pcolor scale-color green chemical 0.1 5 ]
    ]
...
to return-to-nest  ;; turtle procedure
  ...
  [ ;; drop food and head out again
    set color red
    set nest-scent nest-scent + 20  ;; drop some home pheromone
    rt 180
  ]
