patches-own [
  ...
  food-source-number   ;; number (1, 2, or 3, 4) to identify the food sources
...
to setup-nest  ;; patch procedure
  ...
  set nest-scent 200 - distancexy 0 0 ;;set up radially decreasing in the whole world
...
to setup-food  ;; patch procedure
  ...
  ;; setup new food source
  ;;if (distancexy (-0.5 * max-pxcor) (-0.5 * max-pycor)) < 4
...
to setup-poison
  set poison? (distancexy (-0.8 * max-pxcor) (0.8 * max-pycor)) < 5
end
...
to recolor-patch  ;; patch procedure
  ...
  [ ifelse food > 0
    [ if food-source-number = 1 [ set pcolor cyan ]
      ...
      ;;if food-source-number = 4 [ set pcolor orange ]
    ]
...
to look-for-food  ;; turtle procedure
  ...
  ;ask turtles with [countdown = 5] [die]
